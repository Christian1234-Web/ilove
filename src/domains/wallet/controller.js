...
const fundWalletByWallet = async (data) => {
  try {
    ...
    const senderWalletTransaction = await createWalletTransaction(
      senderId,
      "pending",
      "NGN",
      -intAmount,
    ...
    const receiverWalletTransaction = await createWalletTransaction(
      receiverId,
      "pending",
      "NGN",
      intAmount,
    ...
    const pendingWalletTransaction = await createPendingTransaction(
      senderId,
      receiverId,
      amount,
      senderWalletTransaction._id,
      receiverWalletTransaction._id
    );
